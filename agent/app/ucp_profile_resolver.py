...
class ProfileResolver:
    ...
    def _fetch_profile(self, client_profile_url: str) -> dict:
        """Fetch a profile from a URL with local fallback.
        ...
        """
        if "localhost" in client_profile_url or "127.0.0.1" in client_profile_url:
            base_path = Path(__file__).parent
            fallback_path = base_path / "data" / "agent_profile.json"
